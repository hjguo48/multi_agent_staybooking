...
- Status: PASS
- Evidence: `topologies/sequential.py`, `outputs/week3/week3_step2_sequential_report.json`

2. Requirements, architecture, backend, frontend, QA, deployment states are populated.
- Status: PASS
- Evidence: `outputs/week3/week3_step2_state.json`
...
- Status: PASS
- Evidence: `outputs/week3/week3_step2_sequential_report.json`
...
- Status: PASS
- Evidence: `outputs/week3/week3_step2_pipeline_report.json`
